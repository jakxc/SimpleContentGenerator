...
toggleButton.hidden = !riddleContainer.querySelector('p');
...
function showMeme() {
  ...
  memeImage.setAttribute('class', 'meme-image');
  clearAll();
...
function showJoke() {
  ...
  jokePar.textContent = randomJokeText;
  clearAll();
  jokeContainer.appendChild(jokePar);
}

function showQuote() {
  // Value should be in format: { quote: '', author: '' }
  const { quote, author } = getRandomData('quotes');
  ...
  quoteContainer.appendChild(authorPar);
}

function showRiddle() {
  // Value should be in format: { question: '', answer: '' }
  const { question, answer } = getRandomData('riddles');
  const riddlePar = document.createElement('p');
  const answerPar = document.createElement('p');
  riddlePar.textContent = question;
  answerPar.innerHTML = `The answer is: <b>${answer}</b>`
  answerPar.setAttribute('id', 'riddle-answer');
  answerPar.hidden = true;
  toggleButton.textContent = 'Reveal Riddle Answer';
  clearAll();
  riddleContainer.appendChild(riddlePar);
  riddleContainer.appendChild(answerPar);
  toggleButton.hidden = !riddleContainer.querySelector('p');
}
...
function toggleAnswers() {
  ...
  if (riddleAnswer.hidden) {
    ...
    toggleButton.textContent = 'Hide Riddle Answer';
  }
}
